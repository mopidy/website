...
apt.mopidy.com](https://docs.mopidy.com/en/latest/installation/debian/#install-from-apt-mopidy-com)
then please note that not all Mopidy 3 related packages are available there
yet. Most noticeably, our
[Mopidy-Spotify 4 extension](https://mopidy.com/ext/spotify/) is not yet ready.
We will announce when all Debian packages are ready, please continue to be
patient.

If you are [installing from
source](https://docs.mopidy.com/en/latest/installation/pypi/), then yes,
upgrade and enjoy Mopidy 3!
