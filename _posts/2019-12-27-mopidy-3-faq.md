...
features. Most noticeably, [Mopidy-Spotify
4](https://github.com/mopidy/mopidy-spotify/blob/master/CHANGELOG.rst#v400-2019-12-22)
...
v2.3.1](https://docs.mopidy.com/en/latest/history/changelog-2.x/#v2-3-1-2019-10-15).
...
stability in mind; they are *not* designed for running cutting-edge software,
...
remove Mopidy v2.x from your system, but it’s not strictly necessary. Mopidy on
